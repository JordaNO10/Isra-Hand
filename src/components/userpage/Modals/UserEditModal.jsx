/**
 * מודל עריכת משתמש:
 * מציג שדות עריכה, כולל שינוי role אם המשתמש הוא אדמין.
 */
  ...
  return (
    <div className="modal-overlay">
      <div className="modal">
        ...
        <label>שם מלא:</label>
        <input name="full_name" value={formValues.full_name || ""} onChange={onChange} />

        <label>אימייל:</label>
        <input name="email" value={formValues.email || ""} onChange={onChange} />

        <label>טלפון:</label>
        <input name="phone_number" value={formValues.phone_number || ""} onChange={onChange} />

        <label>כתובת:</label>
        <input name="address" value={formValues.address || ""} onChange={onChange} />
